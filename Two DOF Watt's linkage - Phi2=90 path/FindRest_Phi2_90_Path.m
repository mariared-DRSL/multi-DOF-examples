...
% Call optimization
options = optimoptions(@fmincon,'OutputFcn',@outfun,'Display','iter','Algorithm','interior-point','FiniteDifferenceStepSize',1e-3,...
    'MaxFunctionEvaluations',12000,'MaxIterations',2000,'StepTolerance',1e-12,'ConstraintTolerance',0.05,...
    ...
    for j = 1:size(PE,1)
        for i = 1:size(PE,2)
            ...
            if PHI2(j,i) < pi/2
                ...
                desX(j,i) = 0; desY(j,i) = -1;
            elseif PHI2(j,i) > pi/2
